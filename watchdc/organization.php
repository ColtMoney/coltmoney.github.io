...
<div class="wrapper">
    ...
    <main class="main-content w_notif">
        <div class="top_notification">
            <div class="center_text">
                <span class="days"><b>7</b> day (s)</span>
                <p>after 1 day you need to change your password</p>
            </div>
            <div class="right_btns">
                <a href="" class="btn btn-primary">Change</a>
                <a href="" class="btn btn_grey">I remembered</a>
            </div>
        </div>
